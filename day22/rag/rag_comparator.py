...
class RagComparator:
    ...
    def _ask_with_rag(
        ...
        # Create prompt with context - ENHANCED WITH MANDATORY CITATIONS
...
4. If information is not in the provided context, explicitly state: "This information is not available in the provided sources"
5. Multiple citations can be used if information comes from multiple sources
6. Avoiding unsupported claims and hallucinations is critical - only use the provided context

Format your answer to include citations naturally in the text, for example:
